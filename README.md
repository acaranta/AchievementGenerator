...
and obviously apache2 perl interpreter activated
...
2 Usage :
point your browser to http://<whateverhteinstallpath>/generateimage.pl?<parameters>
...
*Allow a way to return directly an url to the cached generted image
